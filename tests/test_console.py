#!/usr/bin/python3
"""Defines the unittest for console.py in AirBnB project...

Unittest classes with their test cases:
...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittest for the testing prompting of HBNB cmd interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittest for testing d help msg of HBNB command interpreter."""

    def test_help_quit(self):
        h = "Quit cmd to exit program."
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_create(self):
        h = ("Usage: create <class>\n        "
             "Creates new class id instance and prints it")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittest to test exiting from the HBNB command interpreter."""
